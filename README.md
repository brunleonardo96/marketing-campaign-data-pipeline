...
-Date Handling: Cast e formattazione date per allineare reporting mensile (YYYY-MM-01).
...
-Chiavi: Brand, Country, Date (Mese), Campaign Name.
-Dimensioni: Type (Email/SMS), Tracking Code, Delivery Label.
...
└── campaign_pipeline.sql   # Codice SQL completo
🧑‍💻 Autore
Leonardo — Data Analyst
Specializzato in Data Integration, SQL Avanzato e Marketing Analytics.
